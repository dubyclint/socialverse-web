...
// Global type augmentation for dynamic HLS lazy loading
declare global {
  interface Window {
    Hls: any
  }
...
export const useAdaptiveStreaming = (config: AdaptiveStreamConfig) => {
  ...
  let hls: any = null
  // ✅ FIXED: Replaced node timeout dependencies with cross-platform window alternatives
  let speedTestInterval: ReturnType<typeof setTimeout> | null = null
  let qualityCheckInterval: ReturnType<typeof setTimeout> | null = null
